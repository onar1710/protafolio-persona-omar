        ...
        {status === 'success' ? (
          ...
          >
            ...
            <button
              ...
              className="w-full py-4 bg-primary text-black font-medium rounded-xl hover:bg-primary/90 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed mt-2"
            >
              {status === 'submitting' ? (
                <>
